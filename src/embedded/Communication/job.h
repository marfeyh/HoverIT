...
@date 23-03-2012
@version 0.1
@authors Dmitry Igoshin and Mozhan Soltani
@n 
@date 09-04-2012
@version 0.2
...
struct Job {
	...
	int arg1;              				  /* @var is passed to the task pointers that take integer arguments ,task_p3,task_p1*/ 	
	unsigned char arg;                   // task_p4
	unsigned char arg2;                  // task_p4
	...
	unsigned char (*task_p4)(unsigned char,unsigned char);
