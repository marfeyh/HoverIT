 ...
 * @ Version      : 1.0
 * @ Refrences    : Arduino.cc, www.sandklef
...
#define BLINK_PIN 11
#define BLINKER(a) { int i; pinMode(BLINK_PIN,OUTPUT);for (i=0;i<10;i++) { digitalWrite(BLINK_PIN,HIGH);delay(a);digitalWrite(BLINK_PIN,LOW);delay(2*a); } delay(1000); }
