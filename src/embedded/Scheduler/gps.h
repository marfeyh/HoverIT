 ...
 * Version: 1.6 - 2012-05-14 - Updated Struct Position, added functions reverse_sign, set_position
 **/
...
/*!
  @brief A function which sets position's sign value based on orientiation value it bares. 
  @param[in] geo_coordinate   a float to be negated its sign value
  @param[in] orientiation   a char notifying orientiation of the geo_coordinate
  @see get_positionA()
  @see get_position()
  @return float
*/
float set_position(float geo_coordinate, char orientiation);

/*!
  @brief A function which returns the negated sign value of a float given as argumenent. 
  @param[in] incoming   a float to be negated its sign value
  @see get_positionA()
  @see get_position()
  @return float outgoing
*/
float reverse_sign(float incoming);
