/*
  ...
  DATA :2012-04-05
  DESCRIPTION: This file is the unit tests for the propulsion and 
               propulsion API functions. check libraries are used 
	       as a tool for the unit tests. 
...
/* 
   Id/Title: tc-06(XK1)/test increase propulsion speed
